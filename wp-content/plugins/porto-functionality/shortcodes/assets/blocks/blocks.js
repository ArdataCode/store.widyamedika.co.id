			...
			callback = function( mutationsList, observer ) {
				for ( var mutation of mutationsList ) {
					if ( mutation.type == 'childList' ) {
						...
						$obj.addClass( porto_block_vars.builder_type );
...
( function( wpI18n, wpBlocks, wpElement, wpEditor, wpBlockEditor, wpComponents, wpData, lodash ) {
	...
	const PortoSingleIcon = function( props ) {
		...
		var inspectorControls = el( Fragment, {}, 
			el( InspectorControls, null,
				el( PanelBody, { title: __( 'General', 'porto-functionality' ) }, 
					el( TextControl, {
						label: __( 'Icon Class', 'porto-functionality' ),
						value: attrs.icon,
						onChange: ( value ) => { props.setAttributes( { icon: value } ); },
...
( function( wpI18n, wpBlocks, wpElement, wpEditor, wpBlockEditor, wpComponents, wpData, lodash ) {
	...
	const PortoInteractiveBanner = function( props ) {
		...
		useEffect(
			...
			[attrs.img_source, attrs.dynamic_content && attrs.dynamic_content.source, attrs.dynamic_content && attrs.dynamic_content.post_info, attrs.dynamic_content && attrs.dynamic_content.metabox, attrs.dynamic_content && attrs.dynamic_content.acf, attrs.dynamic_content && attrs.dynamic_content.toolset, attrs.dynamic_content && attrs.dynamic_content.meta, attrs.dynamic_content && attrs.dynamic_content.tax, attrs.dynamic_content && attrs.dynamic_content.woo],
		);
	...
	registerBlockType( 'porto/porto-interactive-banner', {
		...
		icon: 'porto',
		category: 'porto',
		keywords: ['featured image', 'dynamic image', 'acf image', 'toolset'],
		attributes: {
...
( function( wpI18n, wpBlocks, wpElement, wpEditor, wpBlockEditor, wpComponents, wpData, lodash ) {
	...
	const PortoHeading = function( props ) {
		...
		useEffect(
			...
			[attrs.text_source, attrs.dynamic_content && attrs.dynamic_content.source, attrs.dynamic_content && attrs.dynamic_content.post_info, attrs.dynamic_content && attrs.dynamic_content.metabox, attrs.dynamic_content && attrs.dynamic_content.acf, attrs.dynamic_content && attrs.dynamic_content.toolset, attrs.dynamic_content && attrs.dynamic_content.meta, attrs.dynamic_content && attrs.dynamic_content.tax],
		);
		...
		var inspectorControls = el( Fragment, {},
			el( InspectorControls, {},
				el( PanelBody, { title: __( 'General', 'porto-functionality' ) },
					...
					!attrs.text_source && el( TextareaControl, {
						label: __( 'Title', 'porto-functionality' ),
						help: __( 'Please input the title.', 'porto-functionality' ),
						value: attrs.title,
						onChange: ( value ) => { props.setAttributes( { title: value } ); },
					} ),
					el( SelectControl, {
					...
					el( TextControl, {
						label: __( 'Link', 'porto-functionality' ),
						help: __( 'Please leave empty, if text source is dynamic, so you want to add link automatically.', 'porto-functionality' ),
						value: attrs.link,
						onChange: ( value ) => { props.setAttributes( { link: value } ); },
					} ),					
				),
				'dynamic' == attrs.text_source && el( PanelBody, { title: __( 'Dynamic', 'porto-functionality' ), initialOpen: false },
					el( PortoDynamicContentControl, {
						label: __( 'Dynamic Content', 'porto-functionality' ),
						value: dynamic_content,
				...
				el( PanelBody, { title: __( 'TypeWriter Effect', 'porto-functionality' ), initialOpen: false },
					el( ToggleControl, {
					...
					attrs.enable_typewriter && el( TextControl, {
						label: __( 'Animation Name e.g: fadeInUp, fadeIn and so on.', 'porto-functionality' ),
				...
				el( PanelBody, { title: __( 'Animation', 'porto-functionality' ), initialOpen: false }, 
					el( TextControl, {
						label: __( 'Animation Type', 'porto-functionality' ),
						value: attrs.animation_type,
						help: __( 'Please check this url to see animation types.', 'porto-functionality' ),
			...
			el( InspectorControls, { group: 'styles' }, 
				el( PanelBody, { title: __( 'Font Settings', 'porto-functionality' ) },
					el( PortoTypographyControl, {
		...
		if ( attrs.text_source && attrs.dynamic_content && attrs.dynamic_content.source ) {
			if ( 'post' == attrs.dynamic_content.source && 'title' == attrs.dynamic_content.post_info ) {
				isLink = true;
			} else if ( 'tax' == attrs.dynamic_content.source && 'title' == attrs.dynamic_content.tax ) {
				isLink = true;
			}
		}
		var renderControls = el(
			...
			el(
				...
				null,
				portoGenerateStyleOptionsCSS( style_options, selectorCls ),
				portoGenerateTypographyCSS( font_settings, selectorCls )
			),
			( attrs.text_source && ! isLink ) ? el(
				attrs.tag,
				{
			...
			: (	isLink ? el(
					...
					el(
						'a', { href: attrs.link ? attrs.link : '#' }, realHeadingText
					)
				)
				: el(
					RichText,
	...
	registerBlockType( 'porto/porto-heading', {
		...
		icon: 'porto',
		category: 'porto',
		keywords: ['product title', 'dynamic meta', 'tag', 'text', 'post title', 'blog title', 'taxonomy title', 'sale count', 'taxonomy count', 'category product count'],
		description: __( 'Display the heading including product or post title with dynamic field function.', 'porto-functionality' ),
...
( function( wpI18n, wpBlocks, wpElement, wpEditor, wpBlockEditor, wpComponents, wpData, lodash ) {
	...
	const withCustomClassName = createHigherOrderComponent( ( BlockListBlock ) => {
		return ( props ) => {
			if(props.attributes.is_block) {
				return <BlockListBlock { ...props } className={ 'porto-gb-btn-block' } />;
			} else {
	...
	wp.hooks.addFilter( 'editor.BlockListBlock', 'porto/porto-button', withCustomClassName );
	...
	const PortoButton = function( props ) {
		...
		useEffect(
			() => {
				let field_name = '';
				if ( 'dynamic' == attrs.link_source && attrs.dynamic_content && attrs.dynamic_content.source ) {
					if ( 'post' == attrs.dynamic_content.source ) {
						field_name = attrs.dynamic_content.post_info;
					} else {
						field_name = attrs.dynamic_content[attrs.dynamic_content.source];
			...
			[attrs.link_source, attrs.dynamic_content && attrs.dynamic_content.source, attrs.dynamic_content && attrs.dynamic_content.post_info, attrs.dynamic_content && attrs.dynamic_content.metabox, attrs.dynamic_content && attrs.dynamic_content.acf, attrs.dynamic_content && attrs.dynamic_content.toolset, attrs.dynamic_content && attrs.dynamic_content.meta, attrs.dynamic_content && attrs.dynamic_content.tax, attrs.dynamic_content && attrs.dynamic_content.woo],
		);
		...
		var inspectorControls = el( Fragment, {},
			el( InspectorControls, {},
				el( PanelBody, { title: __( 'Layout', 'porto-functionality' ) }, 
					el( SelectControl, {
						label: __( 'Link Source', 'porto-functionality' ),
						value: attrs.link_source,
						options: [{ label: __( 'Custom Link', 'porto-functionality' ), value: '' }, { label: __( 'Dymamic Link', 'porto-functionality' ), value: 'dynamic' }],
				...
				el( PanelBody, { title: __( 'Icon', 'porto-functionality' ), initialOpen: false }, 
					el( TextControl, {
				...
				el( PanelBody, { title: __( 'Animation', 'porto-functionality' ), initialOpen: false }, 
					...
					attrs.animation_type && -1 !== attrs.animation_type.indexOf( 'revealDir' ) && el(
						'span',
						{ className: 'd-block pb-3' },
						__( 'Reveal Color', 'porto-functionality' )
					),
					attrs.animation_type && -1 !== attrs.animation_type.indexOf( 'revealDir' ) && el( ColorPicker, {
						label: __( 'Reveal Color', 'porto-functionality' ),
						value: attrs.animation_reveal_clr,
						onChange: function onChange( value ) {
							return props.setAttributes( { animation_reveal_clr: value } );
						}
					} ),
				),
			),
		...
		if ( attrs.className ) {
			portoAddHelperClasses( attrs.className, props.clientId );
		}
	...
	registerBlockType( 'porto/porto-button', {
		title: 'Porto Button',
		description: __( 'Create a beautiful layout action with dynamic feature.', 'porto-functionality' ),
		icon: 'porto',
		category: 'porto',
...
( function( wpI18n, wpBlocks, wpElement, wpEditor, wpBlockEditor, wpComponents, wpData, lodash ) {
	...
	const PortoSection = function( props ) {
		...
		var inspectorControls = el( Fragment, {},
			el( InspectorControls, {},
				...
				el( PanelBody, { title: __( 'Background', 'porto-functionality' ), initialOpen: false }, 
					el( PanelColorSettings, {
						title: __( 'Background Color', 'porto-functionality' ),
						initialOpen: false,
						colorSettings: [{
				...
				el( PanelBody, { title: __( 'Shape Divider', 'porto-functionality' ), initialOpen: false }, 
					el( SelectControl, {
	...
	registerBlockType( 'porto/porto-section', {
		...
		icon: 'porto',
		category: 'porto',
		keywords: ['background', 'video', 'image', 'container', 'shape divider', 'section separator', 'flexbox container'],
		attributes: {
			add_container: {
				type: 'boolean',
			},
...
( function( wpI18n, wpBlocks, wpElement, wpEditor, wpBlockEditor, wpComponents, wpData, lodash ) {
	...
	const PortoCountDown = function( props ) {
		...
		useEffect(
				...
				if ( attrs.dynamic_content && attrs.dynamic_content.source ) {
					...
					jQuery.ajax( {
						...
						success: function( res ) {
							...
							if ( attrs.dynamic_content.before ) {
								text = attrs.dynamic_content.before + text;
							}
							if ( attrs.dynamic_content.after ) {
								text = text + attrs.dynamic_content.after;
							}
			...
			[attrs.enable_dynamic_date, attrs.dynamic_content && attrs.dynamic_content.source, attrs.dynamic_content && attrs.dynamic_content.post_info, attrs.dynamic_content && attrs.dynamic_content.metabox, attrs.dynamic_content && attrs.dynamic_content.acf, attrs.dynamic_content && attrs.dynamic_content.toolset, attrs.dynamic_content && attrs.dynamic_content.meta, attrs.dynamic_content && attrs.dynamic_content.tax, attrs.dynamic_content && attrs.dynamic_content.woo],
		);
		...
		var inspectorControls = (
			<InspectorControls>
				<PanelBody title={ __( 'Countdown Timer', 'porto-functionality' ) } initialOpen={ true }>
					...
					/>
					{ 'porto-cd-s2' != attrs.count_style && (
						<TextControl
							label={ __( 'CountDown Label:', 'porto-functionality' ) }
							value={ attrs.countdown_label }
							onChange={ ( value ) => { props.setAttributes( { countdown_label: value } ); } }
						/>
					) }
				</PanelBody>
		...
		var renderControls = attrs.datetime && (
			<div className={ attrs.el_class } >
				{
					attrs.countdown_label && 'porto-cd-s2' != attrs.count_style && <span className="countdown-label">{ attrs.countdown_label }</span>
				}
